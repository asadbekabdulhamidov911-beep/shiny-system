...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-56r^@(0-49q$qe-ly=wb1oa5#xz&hxwgk!v$f_p9%ov0&j_&0a')

# Set DEBUG to False in Railway variables when ready
